...
if ok_to then
  ...
  end, 'ts: inner parameter')
  map({ 'x', 'o' }, 'af', function()
    select.select_textobject('@function.outer', 'textobjects')
  end, 'ts: a function')
  map({ 'x', 'o' }, 'if', function()
    select.select_textobject('@function.inner', 'textobjects')
  end, 'ts: inner function')
  map({ 'x', 'o' }, 'ac', function()
  ...
  end, 'ts: next class start')
  map({ 'n', 'x', 'o' }, ']M', function()
    move.goto_next_end('@function.outer', 'textobjects')
  end, 'ts: next function end')
  map({ 'n', 'x', 'o' }, '][', function()
    move.goto_next_end('@class.outer', 'textobjects')
  end, 'ts: next class end')
  map({ 'n', 'x', 'o' }, '[m', function()
    move.goto_previous_start('@function.outer', 'textobjects')
  end, 'ts: prev function start')
  map({ 'n', 'x', 'o' }, '[[', function()
    move.goto_previous_start('@class.outer', 'textobjects')
  end, 'ts: prev class start')
  map({ 'n', 'x', 'o' }, '[M', function()
    move.goto_previous_end('@function.outer', 'textobjects')
  end, 'ts: prev function end')
  map({ 'n', 'x', 'o' }, '[]', function()
    move.goto_previous_end('@class.outer', 'textobjects')
  end, 'ts: prev class end')
