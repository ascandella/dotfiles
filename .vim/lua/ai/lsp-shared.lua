...
M.on_attach = function(client, bufnr)
  ...
  buf_map(
      bufnr, "n", "[a", ":Lspsaga diagnostic_jump_prev<CR>", { silent = true }
  )
  buf_map(
      bufnr, "n", "]a", ":Lspsaga diagnostic_jump_next<CR>", { silent = true }
  )
  buf_map(bufnr, "n", "ga", ":Lspsaga code_action<CR>", { silent = true })
  buf_map(
      bufnr, "n", "<Leader>gd", ":Lspsaga preview_definition<CR>",
      { silent = true }
  )
  buf_map(
      bufnr, "n", "<Leader>d", ":Lspsaga show_line_diagnostics<CR>",
      { silent = true }
  )
  buf_map(
